 ...
 * Vendored from the Magic UI registry (`shadcn add @magicui/terminal`), with a
 * local `header`/`bodyClassName` addition. The sequencing effects set state
 * synchronously by design; left as upstream ships it so the component can be
 * re-pulled without reconciling a rewrite.
 */
...
interface TerminalProps {
  ...
  sequence?: boolean
  startOnView?: boolean
  /** Replaces the default traffic-light chrome. Pass `null` to drop the bar. */
  header?: React.ReactNode
  /** Applied to the <pre> holding the transcript. */
